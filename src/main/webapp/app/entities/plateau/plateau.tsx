...
import { getEntities } from './plateau.reducer';
...
export class Plateau extends React.Component<IPlateauProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { plateauList, match } = this.props;
    return (
      <div>
        <h2 id="plateau-heading">
          <Translate contentKey="perudoOnlineApp.plateau.home.title">Plateaus</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="perudoOnlineApp.plateau.home.createLabel">Create new Plateau</Translate>
          </Link>
        </h2>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`${match.url}/${plateau.id}/edit`} color="primary" size="sm">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`${match.url}/${plateau.id}/delete`} color="danger" size="sm">
