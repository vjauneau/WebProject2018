...
export class PlateauUpdate extends React.Component<IPlateauUpdateProps, IPlateauUpdateState> {
  ...
  render() {
    const { plateauEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="perudoOnlineApp.plateau.home.createOrEditLabel">
              <Translate contentKey="perudoOnlineApp.plateau.home.createOrEditLabel">Create or edit a Plateau</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : plateauEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="plateau-nom" type="text" name="nom" />
                </AvGroup>
                <AvGroup>
                  <Label id="valeurLabel" for="valeur">
                    <Translate contentKey="perudoOnlineApp.plateau.valeur">Valeur</Translate>
                  </Label>
                  <AvField id="plateau-valeur" type="string" className="form-control" name="valeur" />
                </AvGroup>
