...
import fr.istia.perudo.config.audit.AuditEventConverter;
import fr.istia.perudo.domain.PersistentAuditEvent;
...
import static fr.istia.perudo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
